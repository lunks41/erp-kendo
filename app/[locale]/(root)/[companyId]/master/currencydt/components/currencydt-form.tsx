...
export interface CurrencyDtFormProps {
  initialData?: ICurrencyDt | null;
  companyId: string;
  onSubmitAction: (data: Partial<ICurrencyDt>) => void;
  onCancelAction: () => void;
  isLoading?: boolean;
  isViewMode?: boolean;
}
...
export function CurrencyDtForm({
  ...
  const onFormSubmit = (data: CurrencyDtSchemaType) => {
