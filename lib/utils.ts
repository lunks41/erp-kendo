  ...
  switch (moduleId) {
    case ModuleId.master: {
      ...
      const masterKeyMap: Record<string, keyof typeof MasterTransactionId> = {
        ...
        accountsetupcategory: "accountSetupCategory",
        accountsetupdt: "accountSetupDt",
        coacategory1: "coaCategory1",
        coacategory2: "coaCategory2",
        coacategory3: "coaCategory3",
        credittermdt: "creditTermDt",
        currencydt: "currencyDt",
        currencylocaldt: "currencyLocalDt",
        ...
        gstdt: "gstDt",
        ordertypecategory: "orderTypeCategory",
        servicetypecategory: "serviceTypeCategory",
        taxcategory: "taxCategory",
        taxdt: "taxDt",
        uomdt: "uomDt",
        worklocation: "workLocation",
        chargeglmapping: "chargeGLMapping",
        bargeglmapping: "bargeGLMapping",
      }
      const masterKey =
